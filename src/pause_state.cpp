...
void PauseState::Init() {
    this->_data->assets.LoadTexture("Pause Background", PAUSE_BACKGROUND_IMAGEPATH);
    this->_data->assets.LoadTexture("Resume Button", RESUME_BUTTON_IMAGEPATH);
...
void PauseState::HandleInput() {
    ...
    while (this->_data->window.pollEvent((event))) {
        ...
        if (this->_data->input.IsSpriteSelected(this->_resumeButton, sf::Mouse::Left, this ->_data->window)) {
